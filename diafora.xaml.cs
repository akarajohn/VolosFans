...
{
    public partial class diafora : PhoneApplicationPage
    {
        public diafora()
        {
            InitializeComponent();
            ...
            this.Loaded += diafora_Loaded;
            this.loadFeedButton_Click(null, null);
        }
        WebClient webClient = new WebClient();
        
        void diafora_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void loadFeedButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            // advanced functionality that HttpWebRequest provides, such as the ability to send headers.
                ...
                webClient.DownloadStringAsync(new System.Uri("http://www.volosfans.com/feeds/posts/default/-/%CE%91.%CE%A3.%CE%9F%CE%BB%CF%85%CE%BC%CF%80%CE%B9%CE%B1%CE%BA%CF%8C%CF%82%20%CE%92%CF%8C%CE%BB%CE%BF%CF%85?alt=rss"));
            }
        ...
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            if (this.State.ContainsKey("feed"))
            {
                ...
                if (this.diaforaList.Items.Count == 0)
                {
        ...
        private void UpdateFeedList(string feedXML)
        {
            ...
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                ...
                diaforaList.ItemsSource = ParseFeed(feed);
                ApplicationBarIconButton btn3 = (ApplicationBarIconButton)ApplicationBar.Buttons[0];
                btn3.Text = "ανανέωση";
                btn3.IconUri = new Uri("/Assets/Images/Tiles/refresh.png", UriKind.Relative);
            });
        }
        ...
        private void diaforaList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (listBox != null && listBox.SelectedItem != null)
            {
                ...
                if (sItem.Link.IsAbsoluteUri)
                {
                   ...
                   // NavigationService.Navigate(new Uri("/myBrowser.xaml?url=" + uri.AbsoluteUri, UriKind.Relative));
        ...
        {
            ApplicationBarIconButton btn3 = (ApplicationBarIconButton)ApplicationBar.Buttons[0];
            if (btn3.Text == "ανανέωση")
            {
                btn3.Text = "ακύρωση";
                btn3.IconUri = new Uri("/Assets/Images/Tiles/appbar.cancel.rest.png", UriKind.Relative);
                try
                {
